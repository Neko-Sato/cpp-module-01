...
/*   Updated: 2024/04/25 17:26:44 by hshimizu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void for_winner(std::string s1, std::string s2, std::string filename) {
  ...
  if (!ifs.is_open()) throw std::runtime_error("open error: input file");
  std::ofstream ofs((filename + ".replace").c_str());
  if (!ofs.is_open()) throw std::runtime_error("open error: output file");
  std::string str;
